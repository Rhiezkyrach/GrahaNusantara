...
<!-- main Container -->
<x-main-container title="Tambah Halaman" url="{{ $setting && $setting->Network ? $setting->Network->url : url('/') }}">
  ...
  <div class="flex flex-col mt-5 bg-gray-200 p-4 h-auto w-full rounded-lg">
    ...
    <form method="post" action="/admin/halaman" enctype="multipart/form-data">
      ...
      <div class="w-full h-auto px-2 py-2 border border-green-500 rounded-md itemrow bg-green-100/25">
        <div class="-mt-1.5 mb-2.5 text-center font-semibold"><span class="px-4 py-1 rounded-b-lg bg-green-500 text-white">TAMBAH HALAMAN</span></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 justify-start gap-2">
          ...
          <div class="md:col-span-2 bg-gradient-to-b from-slate-300 rounded-lg">
              ...
              <input type="text" id="inputjudul_situs" name="judul" class="main_input_md" placeholder="Judul Halaman" value="{{ old('judul') }}" autocomplete="off" required>
          ...
          <div class="md:col-span-4 bg-gradient-to-b from-slate-300 rounded-lg">
            ...
            <textarea id="inputisi" name="isi">{{ old('isi') }}</textarea>
