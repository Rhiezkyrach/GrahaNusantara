...
<!-- main Container -->
<x-main-container title="Management Wartawan" url="{{ $setting && $setting->Network ? $setting->Network->url : url('/') }}">

  {{-- table --}}
  <div class="mt-5 w-full">
    {{-- Table Controls --}}
    <x-table-controls addurl="{{ url('admin/wartawan/create') }}"/>
