...
<!-- main Container -->
<x-main-container title="Edit Berita">
  ...
  <div class="flex flex-col mt-5 bg-gray-100 p-4 h-auto w-full rounded-lg">
    ...
    <div class="flex flex-col md:flex-row items-center">
      <div class="w-full md:w-2/12 font-semibold">Kategori</div>
       <div class="flex flex-col w-full md:w-5/12">
        <select id="id_channel" name="id_channel" class="select2 mt-1 md:mt-0 w-full p-2 border border-gray-400 rounded-md" required>
    ...
    <div class="flex flex-col md:flex-row mt-3 items-center">
      ...
      <div class="flex flex-col w-full md:w-10/12">
        <div class="mt-1 md:mt-0 w-full">
          <textarea id="isi" name="isi" class="space-y-5 m-4" required>{{ old('isi', $berita->isi) }}</textarea>
        </div>
        @error('isi')
          <div class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</div>
        @enderror
    ...
    <div class="flex flex-col md:flex-row mt-3 items-center">
      ...
      <div class="flex flex-col w-full md:w-5/12">
        ...
        @endif
        <input type="file" id="foto_penulis" name="foto_penulis" class="mt-1 md:mt-0 w-full px-2 border border-gray-400 rounded-md">
        @error('foto_penulis')
          <div class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</div>
        @enderror
      </div>
    ...
    <div class="flex flex-col md:flex-row mt-3 items-center">
      ...
      <div class="flex flex-col w-full md:w-5/12">
        <select id="id_wartawan" name="id_wartawan" class="select2 mt-1 md:mt-0 w-full p-2 border border-gray-400 rounded-md" required>
    ...
    <div class="flex flex-col md:flex-row mt-3 items-center">
      ...
      <div class="flex flex-col w-full md:w-5/12">
        ...
        @endif
        <input type="file" id="gambar_detail" name="gambar_detail" class="mt-1 md:mt-0 w-full px-2 border border-gray-400 rounded-md" onchange="previewGambar()">
        @error('gambar_detail')
          <div class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</div>
        @enderror
      </div>
    ...
    @if($galeri->count())
      <div class="flex flex-col md:flex-row mt-3 items-center">
        ...
        <div class="flex flex-col w-full md:w-5/12">
          ...
          <input type="file" id="nama_photo" name="nama_photo[]" class="mt-1 md:mt-0 w-full px-2 border border-gray-400 rounded-md" multiple>
          @error('nama_photo')
            <div class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</div>
          @enderror
        </div>
...
<script>
  ...
  $('#gambar_detail').on('change', function(){
  ...
  $('#foto_penulis').on('change', function(){
