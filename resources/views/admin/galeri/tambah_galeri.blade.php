...
<!-- main Container -->
<x-main-container title="Tambah Berita Foto" url="{{ $setting && $setting->Network ? $setting->Network->url : url('/') }}">
  ...
  <div class="flex flex-col mt-5 bg-gray-200 p-4 h-auto w-full rounded-lg">
    ...
    @csrf
      ...
      <div class="w-full h-auto px-2 py-2 border border-green-500 rounded-md itemrow bg-green-100/25">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-2.5">
          ...
          <div class="bg-gradient-to-b from-slate-300 rounded-lg">
              ...
              <select id="inputid_kategori" name="id_kategori" class="select2 main_input_md" disabled>
      ...
      <div class="w-full h-auto px-2 py-2 border border-green-500 rounded-md itemrow bg-green-100/25">
        <div class="-mt-1.5 mb-2.5 text-center font-semibold"><span class="px-4 py-1 rounded-b-lg bg-green-500 text-white">GAMBAR SLIDE</span></div>

        <div class="grid grid-cols-1 gap-2.5">

          {{-- GAMBAR SLIDE --}}
          <div class="images-preview mb-2 grid grid-cols-3 md:grid-cols-5 gap-2 overflow-hidden"></div>
          ...
          <div class="relative bg-gradient-to-b from-slate-300 rounded-lg">
              ...
              <input type="file" id="nama_photo" name="nama_photo[]" class="w-full file-input file-input-bordered" required multiple>
              @error('nama_photo')
