...
<!-- main Container -->
<x-main-container title="Management Berita Foto" url="{{ $setting && $setting->Network ? $setting->Network->url : url('/') }}">
  {{-- table --}}
  <div class="mt-5 w-full">
    {{-- Table Controls --}}
    <x-table-controls addurl="{{ url('admin/galeri/create') }}"/>

    <table id="tableBerita" class="display w-full order-column">
...
$(document).ready(function () {
  let dataDatatable = $('#tableBerita').DataTable({
      'processing': true,
      'serverSide': true,
      'serverMethod': 'get',
      'responsive': false,
