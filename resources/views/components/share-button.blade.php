<div class="w-full mt-2">
  <div class="flex flex-row gap-2 float-right">
    ...
    <div class="block hover:-mt-1 duration-300 ease-in-out">
      <a href="{{ 'https://www.facebook.com/sharer/sharer.php?u=' .  url('berita/' . $slug) }}" 
    ...
    {{-- X --}}
    <div class="block hover:-mt-1 duration-300 ease-in-out">
      <a href="{{ 'https://twitter.com/intent/tweet?url=' .  url('berita/' . $slug) }}" 
          target="_blank" class="flex text-lg p-1 md:p-2 bg-slate-200 hover:bg-slate-300 border border-slate-400 rounded">
    ...
    {{-- Whatsapp --}}
    <div class="block hover:-mt-1 duration-300 ease-in-out">
      <a href="{{ 'https://web.whatsapp.com/send?text=' . $judul . '%0A' .  url('berita/' . $slug) }}" 
      ...
      <a href="{{ 'https://api.whatsapp.com/send?text=' . $judul . '%0A' .  url('berita/' . $slug)  }}"
    ...
    {{-- Telegram --}}
    <div class="block hover:-mt-1 duration-300 ease-in-out">
      <a href="{{ 'https://telegram.me/share/url?url=' .  url('berita/' . $slug) }}" 
          target="_blank" class="flex text-lg p-1 md:p-2 bg-slate-200 hover:bg-slate-300 border border-slate-400 rounded">
